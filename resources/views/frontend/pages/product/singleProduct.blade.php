                        ...
                        <div class="col-lg-3 thumbnails_col order-lg-1 order-2">
                            <div class="single_product_thumbnails">
                                <ul>
                                    ...
                                    <li class="active"><img src="{{ url('frontend/images/single_2_thumb.jpg') }}"
                                            alt="" data-image="{{ url('frontend/images/single_2.jpg') }}">
                                    </li>
                        ...
                        <div class="col-lg-9 image_col order-lg-2 order-1">
                            <div class="single_product_image">
                                <div class="single_product_image_background"
                                    style="background-image:url(/frontend/images/single_2.jpg)"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="product_details">
                    ...
                    <div class="quantity d-flex flex-column flex-sm-row align-items-sm-center">
                        ...
                        <div class="add-to-cart-btn"
                            style="color:white; height:40px; margin-left:15px; display:flex; align-items:center; justify-content:center; padding:0 20px;">
                            <a href=""
                                style="background:none; border:none; color:white; font-size:16px; text-decoration:none;">
                                Add to Cart
                            </a>
                        </div>
                    ...
                    <div id="tab_1" class="tab_container active">
                        <div class="row">
                            <div class="col-lg-5 desc_col">
                                ...
                                <div class="tab_image">
                                    <img src="{{ url('frontend/images/desc_1.jpg') }}" alt="">
                                </div>
                                <div class="tab_text_block">
                                    <h2>Pocket cotton sweatshirt</h2>
                                    <p>Nam tempus turpis at metus scelerisque placerat nulla deumantos solicitud
                            ...
                            <div class="col-lg-5 offset-lg-2 desc_col">
                                <div class="tab_image">
                                    <img src="{{ url('frontend/images/desc_2.jpg') }}" alt="">
                                </div>
                                <div class="tab_text_block">
                                    <h2>Pocket cotton sweatshirt</h2>
                                    <p>Nam tempus turpis at metus scelerisque placerat nulla deumantos solicitud
                                ...
                                <div class="tab_image desc_last">
                                    <img src="{{ url('frontend/images/desc_3.jpg') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
