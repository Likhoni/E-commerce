                        ...
                        <form action="{{route('customer.update', $editCustomer->id)}}" method="post" enctype="multipart/form-data"
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 20px;">
                                ...
                                <div style="flex: 1;">
                                    ...
                                    <input type="text" id="name" name="first_name" value="{{$editCustomer->first_name}}"
                                    ...
                                    <input type="text" id="name" name="last_name" value="{{$editCustomer->last_name}}"
                                        placeholder="Your Name"
                                        style="width: 100%; padding: 10px; margin: 10px 0; border: 1px solid #ddd; border-radius: 5px;">

                                    <label for="Phone Number"
                                        style="color: black; margin-bottom: 5px; font-size: 16px; font-weight: bold;">Phone Number</label>
                                    <input type="number" id="phone_number" name="phone_number" value="{{$editCustomer->phone_number}}"
                                        placeholder="number"
                                        style="width: 100%; padding: 10px; margin: 10px 0; border: 1px solid #ddd; border-radius: 5px;">
                                </div>
                                ...
                                <div style="flex: 1;">
                                    ...
                                    <input type="email" id="email" name="email" value="{{$editCustomer->email}}"
                                        placeholder="Email"
                                        style="width: 100%; padding: 10px; margin: 10px 0; border: 1px solid #ddd; border-radius: 5px;">
                                    ...
                                    <input type="file" id="file" name="file" value="{{$editCustomer->image}}"
                                        style="width: 100%; padding: 10px; margin: 10px 0; border: 1px solid #ddd; border-radius: 5px;">
                                </div>
                            </div>
